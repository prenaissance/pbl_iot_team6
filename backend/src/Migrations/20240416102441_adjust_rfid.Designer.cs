...
{
    [DbContext(typeof(Db))]
    [Migration("20240416102441_adjust_rfid")]
    partial class adjust_rfid
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Dispenser.Models.Audit.ProcessedEvent", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 4, 16, 10, 24, 41, 534, DateTimeKind.Utc).AddTicks(7609),
                    ...
                    b.OwnsOne("Dispenser.Models.Profiles.RfidTag", "RfidTag", b1 =>
                        {
                            ...
                            b1.HasData(
                                ...
                                {
                                    ProfileId = 1,
                                    CreatedAt = new DateTime(2024, 4, 16, 10, 24, 41, 534, DateTimeKind.Utc).AddTicks(5589),
