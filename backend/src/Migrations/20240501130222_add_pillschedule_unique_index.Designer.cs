...
{
    [DbContext(typeof(Db))]
    [Migration("20240501130222_add_pillschedule_unique_index")]
    partial class add_pillschedule_unique_index
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Dispenser.Models.Audit.ProcessedEvent", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 5, 1, 13, 2, 22, 84, DateTimeKind.Utc).AddTicks(7992),
            ...
            modelBuilder.Entity("Dispenser.Models.PillSchedules.PillSchedule", b =>
                {
                    ...
                    b.HasIndex("PillSlotId", "ProfileId")
                        .IsUnique();
                    ...
                    b.OwnsOne("Dispenser.Models.Profiles.RfidTag", "RfidTag", b1 =>
                        {
                            ...
                            b1.HasData(
                                ...
                                {
                                    ProfileId = 1,
                                    CreatedAt = new DateTime(2024, 5, 1, 13, 2, 22, 84, DateTimeKind.Utc).AddTicks(5767),
